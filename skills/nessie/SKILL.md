...
Obsidian vaults. In Hermes, Nessie is available
...
through Hermes over shell commands. Do not apply CLI command tables, shell escaping
...
> into this Hermes session. In team scope I can do the same across the sources
...
When a user asks what Nessie can do, explain that Nessie gives Hermes access
...
Use this workflow when the user asks Hermes to take over, resume, continue,
